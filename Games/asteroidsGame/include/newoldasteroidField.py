...
from include.asteroidType import AsteroidType  # Importing the AsteroidTypes
...
class AsteroidField:
    def __init__(self):
        ...
        self.heartbeat1_sound = pygame.mixer.Sound('sounds/beat1.wav')  # Replace with your sound file path
        self.heartbeat2_sound = pygame.mixer.Sound('sounds/beat2.wav')  # Replace with your sound file path

    def populate(self, count, screen_width, screen_height):
        """Populate the asteroid field with a number of random asteroids."""
        types = [AsteroidType.SMALL, AsteroidType.MEDIUM, AsteroidType.LARGE]  # Use the actual AsteroidType values
        ...
        for _ in range(count):
            ...
            asteroid = Asteroid(x, y, velocity_x, velocity_y, AsteroidType.MEDIUM.value, screen_width, screen_height)
